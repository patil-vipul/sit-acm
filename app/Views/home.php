        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav nav ml-auto">
                    <li class="nav-item"><a class="nav-link text-white border-bottom" data-nav-section="home"><span>Home</span></a></li>
            ...
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
                <div class="col-md-8 ftco-animate mt-5" data-scrollax=" properties: { translateY: '70%' }">
                    <p class="d-flex align-items-center" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                        <a href="https://www.youtube.com/watch?v=riDLxUB7TJA" class="icon-video popup-vimeo d-flex justify-content-center align-items-center mr-3">
            ...
            <div class="row services-section">
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services text-center d-block">
                        ...
                        <div class="media-body">
                            <h3 class="heading mb-3">VISION</h3>
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services text-center d-block">
                        <div class="icon"><span class="flaticon-layers"></span></div>
                        <div class="media-body">
                            <h3 class="heading mb-3">VALUES</h3>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-6 col-lg-4 d-flex">
                    <div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/banner-image.jpg);">
                        <div class="request-quote py-5">
                            <div class="py-2">
                                <span class="subheading">BE PART OF SIT ACM STUDENT CHAPTER</span>
                ...
                <div class="col-md-6 col-lg-8 pl-lg-5 py-5">
                    <div class="row justify-content-start pb-3">
                        <div class="col-md-12 heading-section ftco-animate">
                            ...
                            <h2 class="mb-4">Sinhgad Institute of Technology - ACM Student Chapter</h2>

                            <p>Sinhgad Institute of Technology ACM Student Chapter established in 2021 under the aegis of Department of Computer Science and Engineering, SIT Lonavala.</p>
                            <p> The chapter aims at serving as a dynamic hub of activites for the computing fraternity of Sinhgad Institute of Technology, where enthusiasts meet, interact and learn from each other.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate d-flex">
                            <div class="block-18 text-center py-4 px-3 mb-4 align-self-stretch d-flex">
                                <div class="text">
                                    <strong class="number" data-number="161">0</strong>
                                    <span>Faculty</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate d-flex">
                            <div class="block-18 text-center py-4 px-3 mb-4 align-self-stretch d-flex">
                                <div class="text">
                                    <strong class="number" data-number="680">0</strong>
                    ...
                    <div class="carousel-project owl-carousel">
                        <div class="item">
                            <div class="project">
                                ...
                                <div class="text px-4">
                                    <h3><a href="#">Readers' Circle</a></h3>
                                    <span>Elocution Competition</span>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="project">
                                <div class="img">
                                    <img src="images/event-2.jpeg" class="img-fluid" alt="Colorlib Template">
                                    <a href="images/event-2.jpeg" class="icon image-popup d-flex justify-content-center align-items-center">
                                        <span class="icon-expand"></span>
                                    </a>
                                </div>
                                <div class="text px-4">
                                    <h3><a href="#">Architecture & Working of Java App</a></h3>
                                    <span>Webinar</span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row no-gutters">
                    ...
                    <div class="staff">
                        ...
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                ...
                                <h3 class="mb-4">Darshan Patil</h3>
                                <div class="faded">
                                    <p>Quick learner , hardworking ambitious who isn't afraid to face any challenges.</p>
                ...
                <div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(images/Janaswi_Akare.jpg);"></div>
                        </div>
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">VICE-CHAIRPERSON</span>
                                <h3 class="mb-4">Janaswi Akare</h3>
                                <div class="faded">
                                    <p>Optimistic girl who believes in team work.</p>
                                    <ul class="ftco-social text-center">
                                        <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                                        <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
                                        <li class="ftco-animate"><a href="#"><span class="icon-google-plus"></span></a></li> -->
                ...
                <div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(images/ramsha_khan.jpg);"></div>
                        </div>
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">TEASURER</span>
                                <h3 class="mb-4">Ramsha Khan</h3>
                                <div class="faded">
                                    <p>Optimistic girl who believes in team work.</p>
                                    <ul class="ftco-social text-center">
                                        <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                ...
                <div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(images/Govind_Majage.jpg);"></div>
                        </div>
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">SECRETARY</span>
                                <h3 class="mb-4">Govind Majage</h3>
                                <div class="faded">
                ...
                <div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">CONTENT HEAD</span>
                                <h3 class="mb-4">Dhwani Patel</h3>
                                <div class="faded">
                                    <p>Computer science passionate with great oratory and leadership interests.</p>
                                    <ul class="ftco-social text-center">
                                        <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                                        <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
                                        <li class="ftco-animate"><a href="#"><span class="icon-google-plus"></span></a></li> -->
			...
			<div class="row no-gutters">
                <div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(images/Mansi_Tandulkar.jpg);"></div>
                        </div>
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">NEWSLETTER HEAD</span>
                                <h3 class="mb-4">Mansi Tandulkar</h3>
                                <div class="faded">
                                    <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                                    <ul class="ftco-social text-center">
                                        <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                ...
                <div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(images/Dhananjay_Panage.jpg);"></div>
                        </div>
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">SOCIAL MEDIA HEAD</span>
                                <h3 class="mb-4">Dhananjay Panage</h3>
                                <div class="faded">
                                    <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                                    <ul class="ftco-social text-center">
                                        <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
				...
				<div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">SOCIAL MEDIA CO-HEAD</span>
                                <h3 class="mb-4">Mansi Sharma</h3>
                                <div class="faded">
                                    <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                                    <ul class="ftco-social text-center">
                                        <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
				...
				<div class="col-md-6 col-lg ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text d-flex align-items-center pt-3 text-center">
                            <div>
                                <span class="position mb-2">WEB MASTER</span>
                                <h3 class="mb-4">Vipul Patil</h3>
                                <div class="faded">
                                    <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                                    <ul class="ftco-social text-center">
                                        <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
            ...
            <div class="row d-flex contact-info">
                <div class="col-md-6 col-lg-3 d-flex">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p>Sinhgad Institute Of Technology, Kusgaon, Lonavla, Maharashtra 410401</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="tel://1234567920">+91 8956907841</a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex">
                    <div class="align-self-stretch box p-4 text-center">
                        ...
                        <p><a href="mailto:sit.acm.chapter@gmail.com">sit.acm.chapter@gmail.com</a></p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex">
                    <div class="align-self-stretch box p-4 text-center">
